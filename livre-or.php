...
?>
	<tr>
		<td width ="55px" height = "55px"><?php echo "Posté par:"; echo "<strong>".$row['login']."</strong>"; echo " le "; echo $row['date'];?></td>
		<td width ="185px" height = "185px"><?php echo $row['commentaire'];?></td>
		...
		<td>
		<form method="post">
		<input type="submit"class="effacer" name="effacer" value="Supprimer">
